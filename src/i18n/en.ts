...
export const en = {
  ...
  fundamentals: {
    ...
    rows: {
      ...
      cash_flow:        "Cash flow",
      fcf:              "Free cash flow",
      fintech_funding:  "— of which fintech funding, removed",
      ...
      interest_cover:   "Finance cost coverage",
    ...
    notes: {
      ...
      div_yield:      "cash paid in the period, not declared",
      payout:         "cash paid, over the profit of the period it was paid in",
      interest_cover: "operating profit ÷ finance costs",
      fintech_funding: "customer deposits taken, net of lending",
